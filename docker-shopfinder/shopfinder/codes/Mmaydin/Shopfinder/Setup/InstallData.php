    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'AE',
                'image' => 'mmaydin/shopfinder/images/m/e/mercato-mall.jpg',
                'created_at' => $createdAt
            ]
        );
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'AE',
                'image' => 'mmaydin/shopfinder/images/d/u/dubai-mall.jpg',
                'created_at' => $createdAt
            ]
        );
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'AE',
                'image' => 'mmaydin/shopfinder/images/c/i/city-centre-mirdif.jpg',
                'created_at' => $createdAt
            ]
        );
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'TR',
                'image' => 'mmaydin/shopfinder/images/z/o/zorlu-center.jpg',
                'created_at' => $createdAt
            ]
        );
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'TR',
                'image' => 'mmaydin/shopfinder/images/k/a/kanyon-avm.jpg',
                'created_at' => $createdAt
            ]
        );
        ...
        $setup->getConnection()->insert(
            ...
            [
                ...
                'is_active' => 1,
                'country' => 'TR',
                'image' => 'mmaydin/shopfinder/images/i/s/istinye-park.jpg',
                'created_at' => $createdAt
            ]
        );
